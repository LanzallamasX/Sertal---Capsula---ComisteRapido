...
tl_.timeScale( 1 );  
tl_
.from("#bg img", 8, {scale: 1.3, transformOrigin: "50% 50%", ease: "power3.out"}, "<")
...
.to("#bg", 8, {scale: 2, transformOrigin: "80% 60%", ease: "power2.inOut"}, "<")
...
.to("#bg2", 8, {scale: 1.3, transformOrigin: "50% 0%", ease: "power3.out"}, "<")
.from("#bg2", 0.65, {autoAlpha: 0, ease: "power2.inOut"}, "<")
